...
public class RapportExcel {
    public String genererRapportGlobalMensuel(String DateRapport) {

        String testRapport = "rapport_" + DateRapport + ".xls";
...
//        String filename = "RapportGlobal_ " + monthYear + " .xls";
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            try (FileOutputStream fileOut = new FileOutputStream(testRapport);) {
                workbook.write(fileOut);
            }

            System.out.println("Rapport Excel généré avec succés : " + testRapport);
        } catch (Exception e) {
